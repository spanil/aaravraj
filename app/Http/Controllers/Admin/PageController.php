...
class PageController extends Controller
{
   ...
   {  
        ...
        return redirect()->route('admin.pages.index')->with('success',  __('messages.created'));
    }
    ...
    public function update(UpdateRequest $request, string $id)
    {
        ...
        return redirect()->route('admin.pages.index')->with('success', __('messages.updated'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.pages.index')->with('success', __('messages.deleted'));
    }
