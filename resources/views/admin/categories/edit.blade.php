                ...
                <div class="row">
                    <div class="col-6">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ route('admin.categories.update', ['category' => $data->id]) }}" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="exampleInputEmail1">Is Active ? </label>
             ...
             <input type="radio" name="is_active" class="custom-control-input" value="1" {{$data->is_active == 1 ? 'checked' : ''}}
                          >  <label class="form-check-label" for="active">Active</label>
                              </div>

    <div class="form-check">
             <input type="radio" name="is_active" class="custom-control-input" value = "0" {{$data->is_active == 0 ? 'checked' : ''}} 
