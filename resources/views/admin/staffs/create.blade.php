                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="title" placeholder="Enter  name" value="{{ old('name') }}">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editorshortdescription" name="short_description" class="form-control" rows="4">{{ old('short_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editordescription" name="description" class="form-control" rows="8">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="speciality" class="form-control" id="speciality" placeholder="Enter  speciality" value="{{ old('speciality') }}">
                                    @error('speciality')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="degrees" class="form-control" id="degrees" placeholder="Enter  degrees" value="{{ old('degrees') }}">
                                    @error('degrees')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="training" class="form-control" id="training" placeholder="Enter  training" value="{{ old('training') }}">
                                    @error('training')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="contact_info" class="form-control" id="contact_info" placeholder="Enter  contact_info" value="{{ old('contact_info') }}">
                                    @error('contact_info')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="work_days" class="form-control" id="work_days" placeholder="Enter  work days" value="{{ old('work_days') }}">
                                    @error('work_days')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group">
                                    <div class="removeformgroup">
                                        <label for="services">Services</label>
                                         <input type="text" name="services[]" class="form-control" id="services" placeholder="Enter  title">                                      
                                    </div>
                                </div>

                                  <div class="form-group">
                                      <span onclick="addAssesmentModuleRow()" class="pointer btn btn-primary btn-sm">
                        <i class="fa fa-plus " data-toggle="tooltip" title="" aria-hidden="true" ></i> Add More
                                    </span>
                                  </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <div class="custom-control custom-radio mr-3">
                                            <input class="custom-control-input" type="radio" id="isActiveYes" name="status" value="1" {{ old('status', '1') == 1 ? 'checked' : '' }}>
                                            <label for="isActiveYes" class="custom-control-label">Active</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="isActiveNo" name="status" value="0" {{ old('status') == 0 ? 'checked' : '' }}>
