                        ...
                        <form action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_en" class="form-control @error('title_en') is-invalid @enderror" id="title_en" placeholder="Enter post name" value="{{ old('title_en') }}">
                                    @error('title_en')
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="title_np" class="form-control @error('title_np') is-invalid @enderror" id="title_np" placeholder="Enter post name" value="{{ old('title_np') }}">
                                    @error('title_np')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editordescription_en" name="description_en" class="form-control @error('description_en') is-invalid @enderror" rows="8">{{ old('description_en') }}</textarea>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea id="editordescription_np" name="description_np" class="form-control @error('description_np') is-invalid @enderror" rows="8">{{ old('description_np') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <div class="custom-control custom-radio mr-3">
                                            <input class="custom-control-input" type="radio" id="isFeaturedYes" name="status" value="1" {{ old('status') == '1' ? 'checked' : '' }}>
                                            <label for="isFeaturedYes" class="custom-control-label">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="isFeaturedNo" name="status" value="0" {{ old('status') == '0' ? 'checked' : '' }}>
